...
> Discord role manager tool, bulk assign remove roles 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

👥 &nbsp;**Bulk assign** — give a role to hundreds of members at once

🗑️ &nbsp;**Bulk remove** — strip a role from all members

📋 &nbsp;**Role audit** — see who has what role

🔄 &nbsp;**Role copy** — copy all roles from one server to another

⚙️ &nbsp;**Permission check** — view effective permissions per member

📊 &nbsp;**Role stats** — how many members per role
